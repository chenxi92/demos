...
extension UTType {
    static let emojiart = UTType(exportedAs: "edu.standford.cs193p.emojiart")
}
    ...
    private func fetchBackgroundImageDataIfNecessary() {
        ...
        case .url(let url):
            ...
            let publisher = session.dataTaskPublisher(for: url)
                // chage the publisher't output to be UIImage? instead of (Data, URLResponse)
...
//class EmojiArtDocument_Deprecated: ObservableObject {
//    @Published private(set) var emojiArt: EmojiArtModel {
//        didSet {
//            scheduleAutosave()
//            if emojiArt.background != oldValue.background {
...
//            print("\(thisfunction) couldn't encode EmojiArt as JSON becase = \(encodingError.localizedDescription)")
//        } catch {
